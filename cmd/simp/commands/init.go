...
func Init(cl api.ClientInterface) {
	...
	CreateJobCommand.Flags().StringVarP(&params.jobID, "id", "i", "", "ID do job que será criado (Inteiro)")
	...
	DeleteQueue.Flags().StringVarP(&params.jobID, "id", "i", "", "ID do job que será criado (Inteiro)")
	DeleteQueue.Flags().BoolVarP(&params.all, "all", "a", false, "Aplicar a todos os jobs")
	DeleteExecuting.Flags().StringVarP(&params.jobID, "id", "i", "", "ID do job que será criado (Inteiro)")
	...
	GetJobFromQueueCommand.Flags().StringVarP(&params.jobID, "id", "i", "", "ID do job que será criado (Inteiro)")
	GetJobFromQueueCommand.Flags().BoolVarP(&params.all, "all", "a", false, "Aplicar a todos os jobs")
	GetExecutingJobCommand.Flags().StringVarP(&params.jobID, "id", "i", "", "ID do job que será criado (Inteiro)")
